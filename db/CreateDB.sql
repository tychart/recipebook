...
CREATE TABLE AuthToken (
  ...
  Created_DtTm TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP 
);
...
CREATE TABLE Cookbook_Users (
  ...
  Added_DtTm TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE Recipe (
  ...
  Modified_DtTm TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
